...
class SurfaceMesh( object ):
    ...
    def get_face_points( self, i ):
        if self.is_triangle_face(i):
            return self.vs[self.faces[i][:-1]]
        elif self.is_quadrilateral_face(i):
            return self.vs[self.faces[i]]
    
    def get_face_edges( self, i ):
        if self.is_triangle_face(i):
            return [self.faces[i][0]]
